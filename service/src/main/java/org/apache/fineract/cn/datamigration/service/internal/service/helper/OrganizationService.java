...
public class OrganizationService {
  ...
  public Office findOffice(final String officeIdentifier) {
    Office office = this.organizationManager.findOfficeByIdentifier( officeIdentifier );
    return office;
  }

  public void createOffice(final Office office) {
